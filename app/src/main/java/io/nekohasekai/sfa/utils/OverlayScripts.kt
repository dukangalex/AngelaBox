 ...
 * the list does not run. When a profile is used as a chain entry, its
 * scripts run first and the native chain is compiled from that result.
 */
object OverlayScripts {
    ...
    const val SAMPLE_REVISION = "overlay-revision: 23"
