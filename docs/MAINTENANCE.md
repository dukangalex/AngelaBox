...
| 内核 tag | v1.15.0-chain.4 |
| 发版钉死的 commit | `5ef2960be0aff4f623205373763856cce4844ea1`（`version.properties` 的 `KERNEL_COMMIT`） |
